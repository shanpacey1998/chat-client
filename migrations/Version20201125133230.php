 ...
 */
final class Version20201125133230 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D95AB405B3FB67CD ON user_profile (image_filename)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_D95AB405B3FB67CD ON user_profile');
